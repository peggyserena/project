...
/* ====================== push ====================== */
    ...
    .grid-container .small:hover .push-2 {
...
/* ====================== radioArea ====================== */
    ...
    .box_desktop #myCarousel .carousel-inner img {
        width: 100%;
        height:500px;
        object-fit:contain;
    }
    .box_tablet #myCarousel .carousel-inner img {
        width: 100%;
        height:300px;
        object-fit:contain;
    }
    .box_cellphone #myCarousel .carousel-inner img {
        width: 100%;
        /* height:100%; */
        object-fit:contain;
    }
    ...
    <div class="box_desktop">
        ...
        <div class="grid-container">
            ...
            <div class="small grid_12">
                ...
                <div class="push-2 ">
                    <p class="text-center">融合了熱帶植物及台灣原生植物的英國式花園。<br>內有梅花、櫻花、油桐、杉樹及樹上的各種鳥屋，<br>花園旁設置有咖啡座。<br>露天的市集裡販賣浴鹽、手工皂以及紀念商品，<br>洋溢歐洲市集的休閒氛圍。</ㄣ>
                </div>
    ...
    <div class="box_cellphone">
        <div class="">
            <div class="small " id="map1">
                <h4 class="p-3 m-0 b-green rot-135 c_1 text-center text-white ">薰衣草森林園區導覽圖</h4>
                <img src="images/map/map_01.jpg" alt="">
            </div>
            <div class="small">
                <h3 class="p-3 m-0 b-green rot-135 c_1 text-center text-white ">－ 園區相簿 －</h3>
                <h4 class="p-3 m-0 b-green rot-135 c_1 text-center text-white ">心中一畝田</h4>
                <div >
                    <h3 class="text-secondary">尊重自然，以友善大地的方式，<br>在山上自己種、自己吃，<br>感謝大自然給予的食物。 <br>看著植物努力扎根，<br>我們也找到自己想要的生活樣貌。</h3>
                </div>
