...
<body>
    ...
    <div class="container">
        ...
        <div class=" m-0 p-0">
            <form action="event (3).php" method="get">
                <ul class="d-flex  m-0 p-2 ">
                    ...
                    <button id="submit" type="submit" class="custom-btn btn-4 m-0 p-0" style="width:3rem; ">送出</button>
        ...
        <div class="container con01 m-0 p-0">
            <div class="eventItem  row p-0 m-0">
                <?php foreach ($events as $event) : ?>
                    <h2 class='class="  text-center b-green rot-135 col-12 p-2 m-0'>
                        <?= $event['name'] ?>
                    </h2>
