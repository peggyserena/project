...
<main>
    <div class="container mt-5 mb-5 p-0 box_shadow">
        <h2 class="title text-center">隱私權政策</h2>
        <div style="background-color: white;" class="p-5">
            <h3 class="text-center pb-3">《條款與細則》</h3>
             
            <h4>一、隱私權保護政策的適用範圍
                隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。</h4>
            <br>
            ...
            <br>
            <h4>三、資料之保護</h4>
            <p>只由經過授權的人員才能接觸您的個人資料，如因業務需要有必要委託其他單位提供服務時，本網站亦會嚴格要求其遵守保密義務，並且採取必要檢查程序以確定其將確實遵守。
            </p>
            <br>
            <h4>四、網站對外的相關連結</h4>
