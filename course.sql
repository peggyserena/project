...
--
-- 傾印資料表的資料 `cancel_order`
--

INSERT INTO `cancel_order` (`id`, `order_id`, `user_id`, `price`, `status`, `create_datetime`) VALUES
(116, '202105220116', 20, 400, '已付款', '2021-05-22 23:13:38'),
(117, '202105220117', 20, 0, '已付款', '2021-05-22 23:13:48'),
(118, '202105220118', 20, 400, '已付款', '2021-05-22 23:28:53'),
(119, '202105230119', 20, 800, '已付款', '2021-05-23 05:11:46');
...
(1, 'DR20210523', 1, '愜意雙人房', 'Double Room', 3500, 2500, 3000, 2, 2),
(2, 'TR20210523', 1, '輕奢三人房－樓中樓', 'Triple Room', 4000, 3000, 3500, 2, 3);
...
CREATE TABLE `members` (
  ...
  `other_receiver` varchar(50) DEFAULT NULL,
  `other_mobil` varchar(20) DEFAULT NULL,
  `other_email` varchar(100) DEFAULT NULL,
  `other_zipcode` varchar(10) DEFAULT NULL,
  `other_city` varchar(10) DEFAULT NULL,
...
INSERT INTO `members` (`id`, `email`, `email_2nd`, `fullname`, `birthday`, `mobile`, `zipcode`, `city`, `address`, `other_receiver`, `other_mobil`, `other_email`, `other_zipcode`, `other_city`, `other_address`, `hash`, `created_at`) VALUES
(20, 'peiching46@gmail.com', 'peggy@gmail.com', '陳小桔', '2021-04-01', '090993777', '234', '新北市', '永和區', NULL, NULL, NULL, NULL, NULL, NULL, '$2y$10$aEWE4Ck0wTK0SsMgCOlrReDkRR.QMgN4EzhEskXnYrt6.JOBiiWRS', '2021-05-15 23:48:37'),
(21, 'user22@mail.com', '', 'test', '2021-05-20', '1112', '123', 'ci', 'add', NULL, NULL, NULL, NULL, NULL, NULL, '$2y$10$tkwWzIUmhs3qvVChRVWSiOyoC4xxZ2lS0H9pie5upSKMJQeI.jBgS', '2021-05-16 19:18:03');
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `cancel_order`
--
ALTER TABLE `cancel_order`
