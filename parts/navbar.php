...
<nav id="nav_01" class="navbar navbar-expand-lg navbar-light bg-light active" >
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto" style="flex-wrap:wrap">
            ...
            <li class="nav-item dropdown<?= $pageName == '' ? 'active' : '' ?>">
                <a class="nav-link dropdown-toggle" href="forestnews.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    森林快報
                </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="forestnews.php#gardenInfo">園區相關</a>
                    <a class="dropdown-item" href="forestnews.php#eventInfo">森林體驗</a>
                    <a class="dropdown-item" href="forestnews.php#restaurantInfo">森林咖啡館</a>
                    <a class="dropdown-item" href="forestnews.php#hotelInfo">夜宿薰衣草</a>
                </div>
            </li>
            <li class="nav-item dropdown<?= $pageName == '' ? 'active' : '' ?>">
            ...
            <li class="nav-item dropdown<?= $pageName == '' ? 'active' : '' ?>">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="forestnews.php#restaurantInfo">特惠活動</a>
            ...
            <li class="nav-item dropdown<?= $pageName == '' ? 'active' : '' ?>">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="forestnews.php#eventInfo">特惠活動</a>
            ...
            <li class="nav-item dropdown<?= $pageName == '' ? 'active' : '' ?>">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="forestnews.php#hotelInfo">特惠活動</a>
