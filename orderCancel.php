...
<div class="container mt-5">
    <div class=" orderCancel mb-5 ">
        ...
        <div class="mb-5 ">
            ...
            <div class="m-2">
                <input id="buyer1" type="radio" name="name" value="buyer1" checked/><label for="buyer1 ">同訂購人</label> 
            ...
            <div>
            <h3 class=" title p-2 b-green rot-135">退款帳戶資料</h3>
                <form name="form3" class="row card-body " method="post">
                <a href="http://web.thu.edu.tw/s932954/www/ruten/banklist.htm">銀行代碼查詢</a>
                    <input id="input-field" type="text" name="bankNum" required="required" placeholder="銀行代碼" />
                    <input id="column-left" type="text" name="bankNanme" required="required" placeholder="銀行名稱" />
                    <input id="column-right" type="text" name="bankBranch" required="required" placeholder="分行名稱" />
                    <input id="column-right" type="text" name="bankAccount" required="required"  maxlength="14" placeholder="帳號" />
                    <input id="column-left" type="text" name="name" required="required" placeholder="受款帳戶名稱"  />
                    <textarea style="width:100%" type="text" name="notes" required="required"   placeholder="需求備註" ></textarea>
                </form>
            </div>
        </div>
        <div>
        <input id="agree" type="checkbox" checked><label for="agree"><span>我同意辦理退貨時，由薰衣草森林代為處理發票及銷貨退回證明單，以加速退貨退款作業。依統一發票使用辦法規定，個人發票一經開立，不得更改或改開公司戶發票。<a href="https://www.einvoice.nat.gov.tw/?CSRT=6201288656407980614">財政部電子發票流程說明</a></span></label>
    </div>
